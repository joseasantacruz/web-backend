...
public class ProveedorResourceRESTService {
    ...
    public List<Proveedor> listAllProveedores() {
    	List<Proveedor> proveedores = repository.findAllOrderedByName();
    	System.out.println("Objeto a retornar----" + proveedores);
        return proveedores;
    ...
    /**
     * Alter a proveedor from the values provided. Performs validation, and will return a JAX-RS response with either 200 ok,
     * or with a map of fields, and related errors.
     */
    @PUT
    @Path("/{id:[0-9][0-9]*}")
